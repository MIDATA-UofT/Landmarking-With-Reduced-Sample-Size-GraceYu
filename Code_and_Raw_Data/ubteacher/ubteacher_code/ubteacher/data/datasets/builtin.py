...
# TODO: I need unlabelled dataset here.
...
_SPLITS_COCO_FORMAT["mydata"] = {
    "mydataset_unlabel": (
        "mydata/unlabeled",
        "mydata/unlabeled/_annotations.coco.json",
    ),
}
# TODO: I need the path to the annotations of unlabelled images.
...
# _root = os.getenv("/home/grace_yu/unbiased-teacher/datasets", "mydata")
_root = os.getenv("/home/grace_yu/unbiased-teacher", "datasets")
